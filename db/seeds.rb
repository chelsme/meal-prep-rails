...
chels = User.create(name: "Chelsme", password: "apple", password_confirmation: "apple", img: "Chelsme")
artem = User.create(name: "Artem", password: "soccer", password_confirmation: "soccer", img: "Artem")
aime = User.create(name: "Aime", password: "kombucha", password_confirmation: "kombucha", img: "Aime")
mia = User.create(name: "Mia", password: "100", password_confirmation: "100", img: "Mia")
piero = User.create(name: "Piero", password: "spicy", password_confirmation: "spicy", img: "Piero")
allison = User.create(name: "Allison", password: "boba", password_confirmation: "boba", img: "Allison")
eddy = User.create(name: "Eddy", password: "mustard", password_confirmation: "mustard", img: "Eddy")
devin = User.create(name: "Devin", password: "pecan", password_confirmation: "pecan", img: "Devin")
rocky = User.create(name: "Rocketh", password: "bacon", password_confirmation: "bacon", img: "Rocketh")
adam = User.create(name: "Adam", password: "bacon", password_confirmation: "bacon", img: "Adam")
tany = User.create(name: "Tany", password: "bacon", password_confirmation: "bacon", img: "Tany")
alvin = User.create(name: "Alvin", password: "bacon", password_confirmation: "bacon", img: "Alvin")
casey = User.create(name: "Casey", password: "bacon", password_confirmation: "bacon", img: "Casey")
chelsea = User.create(name: "Chelsea", password: "bacon", password_confirmation: "bacon", img: "Chelsea")
